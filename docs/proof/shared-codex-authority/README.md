...
platform behavior; all 95 pre-existing failures reproduced on the unchanged installed baseline.
`baseline-comparison.json` lists their exact test IDs. Hosted CI
