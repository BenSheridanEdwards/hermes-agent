...
class TestGatewayRuntimeStatus:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("bot_id", "123\nforged"),
            ("bot_username", "fleet_test_bot\x1b[2J"),
        ],
    )
    def test_write_runtime_status_rejects_control_characters_in_public_identity(
    ...
    def test_write_runtime_status_drops_stale_receipt_when_start_time_is_unknown(
        self, tmp_path, monkeypatch
    ):
        monkeypatch.setenv("HERMES_HOME", str(tmp_path))
