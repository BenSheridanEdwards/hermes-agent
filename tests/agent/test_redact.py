...
class TestConfigKeyRedosResistance:
    ...
    def test_secret_keyword_with_large_opaque_payload_completes_fast(self):
        ...
        base64 attachment. The keyword activates config scanning, while the
        unbroken payload made the dotted-key pattern retry from every character
        despite not being a config assignment.
        """
        import time
